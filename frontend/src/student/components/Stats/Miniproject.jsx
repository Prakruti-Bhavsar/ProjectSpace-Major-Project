...
const MiniProject = () => {
  ...
  return (
    <div className="w-full p-4 dark:bg-gray-600 dark:text-gray-500 rounded-lg">
      ...
      <div className="flex justify-between items-center mb-4 border p-3 rounded-md bg-[#fba02a]">
        <h2 className="text-2xl font-bold text-white">Mini Projects</h2>
        <button
          onClick={handlePopup}
          className="w-10 h-10 bg-blue-500 text-white p-2 rounded-full font-bold hover:bg-blue-600 transition shadow-md hover:scale-105"
        >
          +
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-[#62d0f3] p-5 rounded-lg relative hover:shadow-md cursor-pointer">
          <h3 className="text-lg font-bold text-center text-blue-600">Bully Box</h3>
          <p className="mt-1 text-white font-bold text-center">System to give information and raise awareness against bullying by experts.</p>
        ...
        <div className="bg-[#62d0f3] p-5 rounded-lg relative hover:shadow-md cursor-pointer">
          ...
          <p className="mt-1 text-white font-bold text-center">System to give real-time health-related problem solutions.</p>
        ...
        <div className="bg-[#62d0f3] p-5 rounded-lg relative hover:shadow-md cursor-pointer">
          ...
          <p className="mt-1 text-white font-bold text-center">System to reduce the manual process of project allocation.</p>
        ...
        <div className="bg-[#62d0f3] p-5 rounded-lg relative hover:shadow-md cursor-pointer">
          <h3 className="text-lg font-bold text-center text-blue-600">BMI</h3>
          <p className="mt-1 text-white font-bold text-center">System to calculate the BMI of any health.</p>
