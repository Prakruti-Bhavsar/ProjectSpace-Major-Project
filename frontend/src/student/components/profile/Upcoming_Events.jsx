...
const LatestNews = () => {
  ...
  return (
    <div className="w-full max-w-lg mx-auto p-4 bg-white rounded-md dark:bg-gray-600 dark:text-gray-300 border-white shadow-md">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-lg font-bold">Upcoming Events</h2>
        <button
          className="text-sm font-semibold bg-[#ff1565] text-white rounded-md p-2 hover:bg-pink-500 shadow-md"
      ...
      <div className="space-y-4">
        {newsItems.map((item, index) => (
          <div
            key={index}
            className="flex items-center justify-between w-full p-4 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-[#5cc800] shadow-xl"
          >
