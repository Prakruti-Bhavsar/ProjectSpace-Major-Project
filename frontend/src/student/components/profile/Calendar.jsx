...
const Notification = () => {
  ...
  const notifications = [
    { id: 1, name: "Meghna Tiwari", message: "Please check the new updates.", time: "2 hr ago", date: "2024-12-29" },
    { id: 2, name: "Ashutosh Mishra", message: "Are the documents uploaded?", time: "3 hr ago", date: "2024-12-29" },
    { id: 3, name: "Anita Yadav", message: "Can you join the meeting?", time: "5 hr ago", date: "2024-12-28" },
  ...
  return (
    <div className="flex items-center justify-between w-full rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 bg-white ">
      <div className="rounded-lg shadow-lg p-5 w-full">
        {/* Notifications Header with Filter Button */}
        <div className="flex items-center justify-between mb-3">
          <h2 className="text-lg font-bold">Notifications</h2>
          <button
            className="text-sm bg-[#ff1565] px-3 py-2 rounded-md text-[#ffffff] font-semibold hover:scale-105 transition-shadow"
        ...
        <div className="flex justify-between text-sm text-gray-500 mb-2">
          <span className="text-green-500 hover:underline">Today</span>
        ...
        <button className="text-blue-500 text-sm hover:underline">View previous notifications</button>
      </div>
          ...
          <div className="bg-white w-full max-w-screen-md mx-auto p-6 rounded-lg shadow-lg relative">
            ...
            <div className="mb-4">
              ...
              <div className="flex items-center justify-between">
                ...
                />
                <button
                  className="ml-4 bg-[#ff1565] px-4 py-2 rounded-md hover:bg-pink-400 text-white font-semibold"
