...
const FilterProjects = () => {
    ...
    const projects = [
        { id: 1, title: "Project A", year: "Second Year", domain: "Java", semester: "3" },
        { id: 2, title: "Project B", year: "Second Year", domain: "Python", semester: "4" },
        { id: 3, title: "Project C", year: "Third Year", domain: "AI-ML", semester: "5" },
        { id: 4, title: "Project D", year: "Third Year", domain: "Blockchain", semester: "6" },
        { id: 5, title: "Major Project E", year: "Fourth Year", domain: "AI-ML", semester: "7-8" },
    ];
                    ...
                    <div className="w-3/4">
                        ...
                        <div className="grid grid-cols-3 gap-4">
                            ...
                            {filteredProjects.map((project) => (
                                <div key={project.id} className="p-4 border border-gray-300 rounded shadow">
                        ...
                        {filteredProjects.length === 0 && (
                            <p className="text-gray-500 font-medium dark:text-gray-300 mt-4">Projects are not match.</p>
                        )}
                    </div>
                </div>
            </div>
