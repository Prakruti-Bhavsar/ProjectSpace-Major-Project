...
const Calendar = () => {
        ...
        <div className="bg-white p-4 rounded-md w-[320px] shadow-lg">
          ...
          <div className="grid grid-cols-7 gap-2 text-center">
            ...
            {[...Array(daysInMonth).keys()].map((day) => (
              <div
                key={day}
                className={`py-2 cursor-pointer border ${
          ...
          <button className="mt-4 w-full p-2 bg-red-500 text-white rounded" onClick={closePopup}>
            Close
          </button>
        </div>
      </div>
  ...
  return (
    <div className="p-6 ml-64 mr-1 relative bg-white">
      <div className="flex justify-between items-center mb-4">
        <div className="flex items-center gap-2">
          <button className="p-2 border rounded bg-gray-200 hover:bg-gray-300" onClick={() => setYear((prevYear) => prevYear - 1)}>
            &lt;
          </button>
          <span className="p-2 border rounded bg-gray-200 cursor-pointer" onClick={openYearPopup}>
            {year}
          </span>
          <button className="p-2 border rounded bg-gray-200 hover:bg-gray-300" onClick={() => setYear((prevYear) => prevYear + 1)}>
            &gt;
          </button>
          <button className="ml-2 p-2 border rounded bg-blue-500 text-white hover:bg-blue-600" onClick={resetToToday}>
            Today
          </button>
        </div>
        <div className="relative">
          <button className="p-2 border rounded bg-gray-200 flex items-center gap-2 hover:bg-gray-300" onClick={() => setDropdownVisible(!dropdownVisible)}>
