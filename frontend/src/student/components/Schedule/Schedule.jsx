...
const Schedule = () => {
  return (
    <div className="flex flex-col items-start p-6 bg-gray-100 min-h-screen bg-white rounded-md">
        ...
        {events.map((event, index) => (
          ...
          >
            ...
            <div className="flex items-center gap-4 w-2/3">
              ...
              <div className="text-lg text-gray-600 mr-4">All Day</div> {/* Added margin-right to create space */}
              <span className="text-lg text-gray-600">{event.title}</span>
            </div>
          </div>
        ))}
      </div>
