...
const Semesters = ({ selectedYear, selectedCategory, onBack, isDarkMode }) => {
  ...
  return selectedSemester ? (
    ...
    <div className={`p-6 transition duration-300 ${isDarkMode ? 'bg-[#121138] text-white' : 'bg-light text-black'}`}>
      <button
        onClick={onBack}
        className={`mb-4 mt-[-10px] text-lg font-medium underline transition hover:text-blue-600 ${
      ...
      <h2 className="text-3xl font-semibold mb-4">Academic Year: {selectedYear}</h2>
